...
<div class="detail-container">
    <div class="detail-header">
        ...
        <div class="post-info">
            ...
            <span>DATE: <b><fmt:formatDate value="${member.regDate}" pattern="yyyy.MM.dd HH:mm" /></b></span>
        </div>
    </div>
    ...
    <div class="btn-area">
        ...
        <div class="btn-group">
            ...
            <a href="/member/delete?no=${member.no}" class="btn btn-delete" onclick="return confirm('정말 삭제하시겠습니까?')">삭제하기</a>
        </div>
    </div>
