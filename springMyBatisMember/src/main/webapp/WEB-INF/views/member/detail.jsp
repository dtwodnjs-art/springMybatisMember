...
<div class="detail-container">
    ...
    <div class="btn-area">
        <a href="/board/boardList" class="btn btn-list">BACK TO LIST</a>
        
        <div class="btn-group">
            <a href="/board/updateForm?no=${board.no}" class="btn btn-edit">EDIT</a>
            <a href="/board/delete?no=${board.no}" class="btn btn-delete" onclick="return confirm('정말 삭제하시겠습니까?')">삭제하기</a>
        </div>
    </div>
